...
Please use the following link to view step by step docmentation to install [https://github.com/daljitdokal/install-awx-with-k3s-cluster][awx]] on [[https://k3s.io][k3s]].
